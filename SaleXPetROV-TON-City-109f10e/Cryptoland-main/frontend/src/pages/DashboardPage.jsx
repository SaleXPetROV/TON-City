...
export default function DashboardPage() {
  ...
  const getTxTypeLabel = (type) => {
    const labels = {
      'purchase_plot': 'Покупка участка',
      'build_business': 'Строительство',
      'income': 'Доход',
      'transfer': 'Перевод',
    };
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <div className="font-mono text-3xl text-success">
              {(user?.total_income || 0).toFixed(2)} <span className="text-lg">TON</span>
            </div>
          </motion.div>
        </div>
                  ...
                  {businesses.map((biz) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-text-muted">TON/день</div>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  {leaderboard.map((player, index) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-text-muted">TON заработано</div>
                      </div>
                    </div>
                  ))}
                </div>
