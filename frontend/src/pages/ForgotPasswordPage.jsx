...
import { Building2, ArrowLeft, Mail, Lock, KeyRound, CheckCircle2 } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="relative text-left">
                <KeyRound className="absolute left-3 top-3.5 w-5 h-5 text-cyber-cyan" />
                <input 
                  type="text"
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="relative text-left">
                <Lock className="absolute left-3 top-3.5 w-5 h-5 text-cyber-cyan" />
                <input 
                  type="password"
