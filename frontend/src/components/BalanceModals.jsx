...
import { ArrowDownToLine, ArrowUpFromLine, AlertCircle, Info, Clock, Zap, Building2 } from 'lucide-react';
    ...
    if (isOpen) {
      const loadData = async () => {
        try {
          ...
          const [userRes, banksRes] = await Promise.all([
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      if (withdrawType === 'instant') {
        ...
        toast.success('Запрос на вывод отправлен! Обработка в течение 24 часов.');
      }
